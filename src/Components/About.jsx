    ...
    <section id="about" className="pt-20 bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mx-2 mb-10">
          {/* Card 1 */}
          <div className="p-6 bg-gray-50 dark:bg-gray-800 dark:hover:bg-mist-800 shadow-xl hover:shadow-2xl rounded-xl text-center hover:scale-102 transition-all duration-300">
