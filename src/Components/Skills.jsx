...
const Skills = () => {
  const skills = {
    technical: [
      {
        icon: <Code2 size={24} className="text-indigo-700 dark:text-indigo-400" />,
        name: "Frontend Development",
        skills: ["React.js", "JavaScript (ES6+)", "Tailwind CSS", "HTML5"],
      },
      {
        icon: <Terminal size={24} className="text-indigo-700 dark:text-indigo-400" />,
        name: "Backend Development",
        skills: ["Node.js", "Express.js", "MongoDB & MySQL", "RESTful APIs", "JWT Authentication"],
      },
      {
        icon: <Brain size={24} className="text-indigo-700 dark:text-indigo-400" />,
        name: "Development Tools",
        skills: ["Git", "VS Code", "Postman", "MongoDB Compass", "NPM"],
      },
      {
        icon: <Puzzle size={24} className="text-indigo-700 dark:text-indigo-400" />,
                  ...
                  <ul className="space-y-2">
                    {category.skills.map((skill, i) => (
                      <li key={i} className="text-gray-600 dark:text-gray-300 flex items-center gap-2">
                        <span className="w-2 h-2 bg-indigo-700 dark:bg-indigo-400 rounded-full"></span>
                        {skill}
                      </li>
                    ))}
                  </ul>
