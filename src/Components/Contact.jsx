...
import bg from '../assets/authentication-hsecjhr9.png'
          ...
          <div className="bg-white mx-4 mb-6 py-7 px-5 rounded-2xl shadow-sm space-y-8" style={{backgroundImage: `url(${bg})`}}>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a href="mailto:tanjirulanonto48@gmail.com" className="text-indigo-700 hover:text-indigo-800 hover:font-semibold">
                tanjirulanonto48@gmail.com
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a href="tel:+8801606074498" className="text-indigo-700 hover:text-indigo-800 hover:font-semibold">
                +8801606074498
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a href="https://wa.me/+8801606074498" className="text-indigo-700 hover:text-indigo-800 hover:font-semibold">
                +8801606074498
                </a>
              </div>
            </div>
